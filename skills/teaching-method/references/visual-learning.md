...
Humans process visuals far faster than text. For a speed learning mode, diagrams are not optional — they are the primary teaching tool.
...
4. Always use Mermaid (renders in GitHub, VS Code, most markdown viewers). In a raw terminal it will not render — pair it with a table or ASCII fallback.
